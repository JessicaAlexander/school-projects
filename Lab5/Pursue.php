...
$ratio= 0.66;
    ...
    $BAC = number_format ($BAC, 2);

    print "<p>If your current weight is <span class=\"number\">$Weight</span> pound(s) and you've had a total of <span class=\"number\">$Number_of_drinks </span> alcoholic drinks with an alcohol content of <span class=\"number\">$Amount_of_alcohol</span> percent over a span of <span class=\"number\">$Hours</span> hours and you are $Gender your total blood alcohol content will be <span class=\"number\">$BAC</span>.<br>
